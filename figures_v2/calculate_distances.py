...
human_typ = pandas.read_csv('/home/andrewstier/Downloads/human_rated_typicality.csv')
eu_data = pandas.read_csv('/home/andrewstier/Downloads/concept_embeddings_cr_cat_16eu.csv')
hbp_data = pandas.read_csv('/home/andrewstier/Downloads/concept_embeddings_cr_cat_3hbp.csv')
...
within_cat_idx = [numpy.argwhere(hbp_data['bigcat']==hbp_data['bigcat'].values[i]) for i in range(hbp_data.shape[0])]
within_cat_idx = [within_cat_idx[i][within_cat_idx[i]!=i] for i in range(hbp_data.shape[0])]

between_cat_idx = [numpy.argwhere(hbp_data['bigcat']!=hbp_data['bigcat'].values[i]) for i in range(hbp_data.shape[0])]
...
plt.savefig('/home/andrewstier/Downloads/membatross/within_between.png',dpi=300)
...
plt.savefig('/home/andrewstier/Downloads/membatross/within_between_native.png',dpi=300)
...
plt.savefig('/home/andrewstier/Downloads/membatross/within_between_radius_hbp_native.png',dpi=300)
...
plt.ylabel('Hyperbolic Radius')
plt.legend(ncols=2,fontsize='xx-small')
plt.savefig('/home/andrewstier/Downloads/membatross/within_between_radius_hbp_euclidean.png',dpi=300)
...
plt.legend(ncols=2,fontsize='xx-small')
plt.savefig('/home/andrewstier/Downloads/membatross/within_between_radius_euclidean.png',dpi=300)
